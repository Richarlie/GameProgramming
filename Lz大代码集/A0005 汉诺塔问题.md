...
void hanoi(int n, string from_rod, string to_rod, string aux_rod) 
{
    if (n == 1) {
        ...
        hanoi(n - 1, from_rod, aux_rod, to_rod);//from,aux,to
        cout << from_rod << "->" << n << "->" << to_rod << endl;//输出
        hanoi(n - 1, aux_rod, to_rod, from_rod);//aux,from,to
    }
}
//背这段代码很简单 ，把n看成是2，n-1看成是1，照着想象的画面去写出来就好力!
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4NzcwMTIwOTgsNDM1MDcwOTg1LDEzNT
Y0NDc4MTZdfQ==
-->