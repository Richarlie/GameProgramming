...
2. **创建**
**基本类型**
![输入图片说明](/imgs/2026-01-03/3eH9SUk4vsxJXRM8.png)
**引用类型**
![输入图片说明](/imgs/2026-01-03/lCmYqyY3j216D648.png)
3. **初始化**
...
（4）**静态成员**
a. 静态变量：
![输入图片说明](/imgs/2026-01-03/UKLwGUi1AfP0zfwY.png)
...
5. **对象生命周期——初始化块**
![输入图片说明](/imgs/2026-01-03/C5FdEdMgNtqVjRxE.png)

6. **包**
**“使用包的主要原因是确保类名的唯一性”**
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIxMDc4OTkwOTMsMTgwOTk1MTk3Miw3ND
g1MTUwMjksMzgzNzgxMjEyLDE1MTM2MzY2MjQsLTQ4NjA3MzY3
MSwxNjI5MTc4NzgzLDE2MTUzNDkyMiwxNDY4MDg5NzUxLC0xOD
IxNjA2NDc0LDUzMDQ3NTU4OCw0NjYwNTg3NjcsLTEyOTYzNDk3
NTIsNjk3MTY4NTM2LDE4NjYwMTIxMDIsMTIwNzg1MTc2NiwxMz
MyMjkwMTU4LDk5MTk1Mzc2MiwtNzQ2Mzk3MjAyLC0xOTMyNzM1
NDY2XX0=
-->