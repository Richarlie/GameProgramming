...
## MatLab代码：
 ...
 - `Max_eig=max(max(D));`:第一次求最大得矩阵，第二次求最大则提取出最大值（其中max是求每列的最大值）
   
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTU5NDI0NjU2NSwzNzkyODcxNjcsLTcxOT
U2OTA1NiwtODA5ODMyNDc3LDEyNzIzMDMwNCwxMDA2MjM0MTY1
LDUzNDgxMzA0OCw2NTk3NTc2LDE3MTM4ODk5NzAsMzk4NTU3MD
RdfQ==
-->